...
|---|---|---:|---|---|
| `TASK-015` | [拆分 `AppModel` 状态域并封装状态方法](app-model-refactoring.md) | P1 | `in_progress` | 已拆 Connection、Navigation 和 Dialog 输入基础，已消除共享输入字段；待完成 Dialog 语义并拆 Log、Detail、Exec、Compose、Feedback |
