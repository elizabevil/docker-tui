...
func (lv *LabeledValue) Render() string {
	labelStyle := styleWithBackground(component.GetStyle(string(lv.LabelStyle)), lv.Background)
	valueStyle := styleWithBackground(component.GetStyle(string(lv.ValueStyle)), lv.Background)
