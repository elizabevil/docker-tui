...
func TestApplyThemeStylesProjectsFixedScopes(t *testing.T) {
	...
	theme.Chrome.HeaderLabel = config.TokenRef(config.ColorTokenAccentSecondary)
	theme.Chrome.DialogTitle = config.TokenRef(config.ColorTokenAccent)
	theme.Feedback.ToastSuccess = config.TokenRef(config.ColorTokenPrimary)
	theme.Surfaces.RowSelected = config.TokenRef(config.ColorTokenBackgroundDeep)
	theme.Feedback.SafeNormal = config.TokenRef(config.ColorTokenForeground)
	theme.Feedback.SafeAccent = config.TokenRef(config.ColorTokenPrimary)
	theme.Feedback.SafeError = config.TokenRef(config.ColorTokenDanger)
	theme.Data.MarkedBackground = config.ValueRef(config.FallbackColorTableMarkedBackground)
	theme.Data.NameForeground = config.ValueRef(config.FallbackColorTableNameForeground)
	theme.Data.ColumnForeground = config.ValueRef(config.FallbackColorTableColumnForeground)
	theme.Surfaces.Footer = config.TokenRef(config.ColorTokenBackgroundDeep)
	theme.Surfaces.Panel = config.TokenRef(config.ColorTokenDanger)
	theme.Surfaces.ActionBar = config.TokenRef(config.ColorTokenAccent)
	theme.Surfaces.MessageRail = config.TokenRef(config.ColorTokenBackgroundSubtle)
	theme.Surfaces.QueryBar = config.TokenRef(config.ColorTokenAccentSecondary)
